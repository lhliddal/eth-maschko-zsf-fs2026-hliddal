...
%
% MaschKo-Ausnahme: Wegen der dicht abgestimmten Spalten- und Seitenumbrüche
% wird Flattersatz nicht global, sondern nur lokal in Textcontainern aktiviert.
% ============================================================
...
% ------------------------------------------------------------
% Globaler Umbruchschutz für Inline-Mathematik (pdfLaTeX)
% ------------------------------------------------------------
% Setzt die Strafpunkte für Zeilenumbrüche an Binäroperatoren (+)
% und Relationszeichen (=) auf unendlich, um Umbrüche in $...$
% im gesamten Dokument zu unterbinden.
\binoppenalty=10000
\relpenalty=10000
