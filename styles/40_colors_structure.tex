...
% Variablenfarben-Steuerung wurde nach styles/10_math.tex verschoben,
% damit sie auch für das semantische Formel-Highlighting zur Verfügung steht.
...
\definecolor{ZSFMutedTextColor}{HTML}{8D8D8D}
...
% Die dritte Ebene bleibt als Bauteil-Locator erhalten, tritt visuell aber
% klar hinter Kapitel und Unterkapitel zurück.
...
\newcommand{\FigboxBackColor}{\chaptercolorlight!14}
\newcommand{\FigboxTitleBackColor}{\chaptercolorlight!28}
\newcommand{\FigboxTitleTextColor}{TextVorBoxColor}
...
\newcommand{\ZSFConsumeAfterSubsectionBar}{\global\zsfAfterSubsectionBarfalse\global\zsfAfterChapterBarfalse}

% Reduzierter "before skip" für Boxen direkt nach einer SubsectionBar.
% MaschKo-Verdichtung: S -> XS (Box-zu-Box-Gap 2pt statt 3pt; 6-Seiten-Ziel)
\newcommand{\ZSFBoxBeforeSkip}{%
  \ifzsfAfterSubsectionBar\ZSFsubsectionAfterGap\else\ZSFspaceXS\fi
}
