...
% MaschKo: proportional zur 6.75pt-Basis verkleinert (Template-Default: 8.1/6.7bp bei 8pt-Basis)
% MaschKo-Verdichtung: 7.4/8.3 -> 7.0/7.6 (6-Seiten-Ziel; ~200 Balken/Titel)
\newcommand{\ZSFfontChapter}{\sffamily\bfseries\fontsize{7.0bp}{7.6bp}\selectfont}
\newcommand{\ZSFfontSection}{\sffamily\bfseries\fontsize{7.0bp}{7.6bp}\selectfont}
\newcommand{\ZSFfontSubsubsection}{\sffamily\bfseries\fontsize{6.6bp}{7.1bp}\selectfont}
\newcommand{\ZSFfontBoxTitle}{\sffamily\bfseries\fontsize{7.0bp}{7.6bp}\selectfont}
% chktex 6
\newcommand{\ZSFfontNote}{\sffamily\fontsize{6.2bp}{6.5bp}\itshape\selectfont} % MaschKo-Verdichtung: 6.9 -> 6.5 leading (6-Seiten-Ziel)
...
\newcommand{\ZSFfontTitleTag}{\sffamily\fontsize{6.4bp}{7.0bp}\itshape\color{\chaptercolortext}\selectfont}
\newcommand{\ZSFfontRel}[2]{\fontsize{\dimexpr 8bp + #1\relax}{\dimexpr 8bp + #1 + #2\relax}\selectfont}
...
\newcommand{\ZSFmuted}[1]{{\color{ZSFMutedTextColor}#1}}
...
% \ZSFsource{Relation}{label} — Quelle einer in einer Formel verwendeten
% Grösse. Die Relation benennt bewusst die Art der Abhängigkeit:
%   aus            = denselben berechneten Wert übernehmen
%   bestimmen mit  = am Ziel die passende Fallformel auswählen
% Anders als \ZSFref ist dies kein allgemeiner Lesehinweis, sondern ein
% kompakter Formel-Lookup. Die Zielnummer übernimmt dessen Wegweiserfarbe.
\newcommand{\ZSFsource}[2]{%
  \begingroup
  \ZSF@refComputeTargetColor{#2}%
  \hyperref[#2]{{\upshape\bfseries\color{\ZSF@refTargetColor}#1~\ref*{#2}}}%
  \endgroup
}
\makeatother

\newcommand{\ZSFconclusion}[1]{%
  \par\vspace{-\parskip}\vspace{\ZSFspaceXS}% MaschKo-Verdichtung: S -> XS
